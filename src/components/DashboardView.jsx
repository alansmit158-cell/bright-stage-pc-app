    ...
    const ActionButton = ({ icon, label, onClick, color }) => (
        ...
        >
            ...
            <div className="btn-text-wrapper">
                ...
                <span className="btn-status">Click to open</span>
            </div>
                    ...
                    <div className="dash-actions" style={{ marginTop: '30px' }}>
                        ...
                        <div className="action-buttons" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginTop: '20px' }}>
                            ...
                            {(isFounderOrManager || isSiteManager || isWorker) && (
                                <ActionButton
                                    icon="📦"
                                    label={t('my_orders') || 'Mes Commandes'}
                            ...
                            {(isFounderOrManager || isStorekeeper) && (
                                <ActionButton
                                    icon="✅"
                                    label={`${t('validate_orders') || 'Valider Commandes'} (${stats.unvalidatedCount || 0})`}
                            ...
                            {(isFounderOrManager) && (
                                <ActionButton
                                    icon="📄"
                                    label={t('exit_slips') || 'Bons de Sortie'}
                                    onClick={() => navigate('/projects')}
                                    color="#f59e0b"
                                />
                            )}
                            ...
                            <ActionButton
                                icon="🛠️"
                                label={t('maint_dash') || 'Tableau de Bord Maintenance'}
