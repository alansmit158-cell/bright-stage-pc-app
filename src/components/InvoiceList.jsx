...
const InvoiceList = () => {
    ...
    const handleDownload = async (id, number, companyId = 'bright') => {
        try {
            const resPdf = await api.get(`/invoices/${id}/pdf?company=${companyId}`, { responseType: 'blob' });
                                ...
                                <td style={{ padding: '20px 24px', textAlign: 'right', display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                                    ...
                                    <button
                                        ...
                                        onMouseEnter={(e) => {
                                            ...
                                            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(99, 102, 241, 0.35) 0%, rgba(167, 139, 250, 0.35) 100%)';
                                        }}
                                        onMouseLeave={(e) => {
                                            e.currentTarget.style.transform = 'translateY(0)';
                                            e.currentTarget.style.boxShadow = '0 4px 15px rgba(0, 0, 0, 0.2)';
                                            e.currentTarget.style.background = 'linear-gradient(135deg, rgba(99, 102, 241, 0.2) 0%, rgba(167, 139, 250, 0.2) 100%)';
                                        }}
                                        style={{ 
            ...
            {showCompanySelect && (
                <div className="modal-overlay-blur" style={{ 
                    ...
                    <div className="premium-modal" style={{ 
                        maxWidth: '450px', width: '90%', padding: '40px', background: '#0f172a', 
                        border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '32px', textAlign: 'center' 
                    }}>
                        <div style={{ marginBottom: '25px' }}>
                            <div style={{ fontSize: '40px', marginBottom: '15px' }}>🏢</div>
                            <h2 style={{ fontSize: '24px', fontWeight: '800', color: '#fff' }}>Select Company Profile</h2>
                            <p style={{ color: '#94a3b8', marginTop: '10px' }}>Choose identity for invoice {activeInvoice?.number}</p>
                        </div>

                        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                            <button 
                                onClick={() => {
                                    handleDownload(activeInvoice._id, activeInvoice.number, 'bright');
                                    setShowCompanySelect(false);
                                }}
                                style={{ 
                                    padding: '16px', borderRadius: '16px', border: 'none', cursor: 'pointer',
                                    background: 'linear-gradient(135deg, #6366f1 0%, #4f46e5 100%)',
                                    color: '#fff', fontSize: '16px', fontWeight: '700', transition: 'transform 0.2s'
                                }}
                            ...
                            <button 
                                onClick={() => {
                                    handleDownload(activeInvoice._id, activeInvoice.number, 'square');
                                    setShowCompanySelect(false);
                                }}
                                style={{ 
                                    padding: '16px', borderRadius: '16px', border: 'none', cursor: 'pointer',
                            ...
                            <button 
                                ...
                                style={{ 
                                    ...
                                    color: '#94a3b8', padding: '12px', borderRadius: '16px', marginTop: '10px', cursor: 'pointer' 
                                }}
                            >
                                Cancel
                            </button>
